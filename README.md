...
Using the Visual Studio Developer Command Prompt or PowerShell:
...
In Visual Studio, locate the Startup Item dropdown.
...
└── CMakeLists.txt      # Root configuration# InvoiceApplication
